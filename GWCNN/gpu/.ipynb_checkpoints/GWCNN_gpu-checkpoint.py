...
import random
from build_fg_gpu import build_data_strict_all,build_gkernel,\
...
def write_out_pdb(fpath,vecs,scores,scorecut = None):
    ...
    for i in range(min(99999, len(dump_sorted))):
...
#     if len(sys.argv) != 3:
#         print('usage: GWCNN_gpu.py [input PDB/mmCIF] [output name]')
        
#     else:    
#         pro_path = sys.argv[1]
#         out_name = sys.argv[2]
#         tlog_path ='cpu_time.log'
#         nets = [transform_model(networks.Net_v4_5_auxloss(), nn.Conv3d, BayesConv3d, 
...
if __name__ == '__main__':
    ...
    nets = [networks.Net_v4_5_auxloss_2()]
